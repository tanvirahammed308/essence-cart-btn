...
const NewArrival = ({products,handleAddToCart}) => {
    const filterNewArrival=products.filter((item)=>item.productDisplayCategory ==="New Arrival")
  ...
  return (
    <div className='my-5  '>
        ...
        '><span className='text-[#5CAF90]'>New </span>  Arrival </h1>
           <div className='grid md:grid-cols-4 gap-10 md:gap-60 justify-center items-center'>
             {
                 filterNewArrival.map((item)=><div className="card bg-base-100 w-80  shadow-sm ">
                 <figure>
                   <img
